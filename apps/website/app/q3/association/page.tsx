        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4 lg:space-x-8 text-sm sm:text-base">
              ...
              <Link href="/q3/association" className="text-blue-600 dark:text-blue-400 font-medium whitespace-nowrap hidden sm:block">
                The Association
              </Link>
              <Link href="/q3/association" className="text-blue-600 dark:text-blue-400 font-medium whitespace-nowrap sm:hidden">
                Association
              </Link>
