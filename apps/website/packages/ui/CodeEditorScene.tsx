      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-64 bg-gray-800 border-r border-gray-700 p-2 flex flex-col overflow-hidden">
          ...
          <div className="space-y-1 overflow-y-auto flex-1">
            ...
            <div 
              ...
              onMouseEnter={() => setHoveredBlock("initialization")}
            ...
            {CODE_BLOCK_GROUPS.map((group) => {
              ...
              return (
                <div 
                  ...
                  onMouseEnter={() => setHoveredBlock(group.key)}
                  onMouseLeave={() => setHoveredBlock(null)}
            ...
            <div 
              ...
              onMouseEnter={() => setHoveredBlock("simulation-assembly")}
              onMouseLeave={() => setHoveredBlock(null)}
              className={`px-2 py-1 text-gray-300 text-sm rounded cursor-pointer transition-colors ${
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
            ...
            >
              {isCopied ? (
                <>
                  ...
                  <span className="transition-all duration-200">Copied</span>
                </>
              ) : (
          ...
          <div 
            ...
            className="flex-1 p-4 font-mono text-sm bg-[#222222] overflow-y-auto overflow-x-auto"
          >
              ...
              {allBlocks.map((block) => (
                <div 
                  ...
                  className={`transition-colors duration-200 rounded px-2 -mx-2 ${
                    hoveredBlock === block.key ? 'bg-gray-800/50' : ''
                  }`}
                >
